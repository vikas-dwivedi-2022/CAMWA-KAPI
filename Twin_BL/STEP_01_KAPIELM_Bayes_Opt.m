...
% Define optimization variables (for all nu values)
optimVars = [
    optimizableVariable('w1', [0.495, 0.505]), ...
    optimizableVariable('w2', [0.495, 0.505]), ...
    optimizableVariable('w3', [0.001, 0.01]), ...
    optimizableVariable('w4', [0.99, 0.999]), ...
    optimizableVariable('w5', [0.01, 0.1]), ...
    optimizableVariable('w6', [0.01, 0.1]), ...
    optimizableVariable('w7', [0.5, 1]), ...
    optimizableVariable('w8', [0.5, 1])
];
...
function KAPI_Training_History(results)
    ...
    % ylabel('Log(Best J)', 'Interpreter', 'latex', 'FontSize', 20);
    ...
    xlabel('Iteration', 'Interpreter', 'latex', 'FontSize', 18);
    ylabel('Parameter Value', 'Interpreter', 'latex', 'FontSize', 20);
    % legend(w_names, 'Interpreter', 'latex', 'FontSize', 12, 'Location', 'eastoutside');
    legend({'$f_1$', '$f_2$','$\mu_1$', '$\mu_2$', '$\tau_1$', '$\tau_2$', '$\lambda_1$','$\lambda_2$'}, ...
